...
<!-- FILEINPUT CSS -->
<link rel="stylesheet"
	href="assets/vendor/fileinput/css/fileinput.min.css">
<!-- MAIN CSS -->
<link rel="stylesheet" href="assets/css/main.css">
<!-- FOR DEMO PURPOSES ONLY. You should remove this in your project -->
<link rel="stylesheet" href="assets/css/demo.css">
<!-- GOOGLE FONTS -->
<link href="./assets/css/SourceSansPro.css" rel="stylesheet">
<!-- ICONS -->
...
<body>
	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				...
				<ul class="nav">
					...
					<li><a href="upload.html" class="active"><i
								...
								<form id="upload_form" class="form-horizontal" role="form"
									...
									<div class="form-group">
										<input type="text" name="password" class="form-control"
											placeholder="Please input your password"><br>
									</div>  -->
									<div class="form-group">
										<input id="f_upload" type="file" class="file fileloading" name="uploadfile"  multiple data-min-file-count="1" >
									</div>
		...
		<footer>
		<div class="container-fluid">
			<p class="copyright">Copyright &copy; 2017.Company name All
				rights reserved.</p>
		</div>
		</footer>
	</div>
	...
	function getRootPath_dc() {
		...
		var url = getRootPath_dc()+"/uploadfiles";
		...
		$("#f_upload").fileinput({
			...
			msgFilesTooMany: "The maxFileCount is 10.",
			dropZoneTitle: "Please drag & drop files here."
		});
