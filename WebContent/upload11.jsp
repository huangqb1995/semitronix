						...
						<div class="panel-body">
							<form class="form-horizontal" role="form"
								...
								<div class="form-group">
									<input type="text" name="uname" class="form-control" placeholder="Please input your name"><br>
								</div>
								<div class="form-group">
									<input type="text" name="password" class="form-control" placeholder="Please input your password"><br>
								</div>
								<div class="form-group">
